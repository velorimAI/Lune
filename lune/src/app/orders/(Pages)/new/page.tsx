          ...
          <Form cancelHide submitHide onSubmit={handleSubmit} >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-1 mb-2">
              <Input
                ...
                className={`${!customerInfo.name.trim() ? "border-red-500" : ""
                  }`}
              />
              <Input
                ...
                className={`${!customerInfo.phone_number.trim() ? "border-red-500" : ""
                  }`}
              />
              <Select
                ...
                className={`${!customerInfo.car_status.trim() ? "border-red-500" : ""
                  }`}
              />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-1 mb-2">
              <Input
                ...
                className={`${!receptionInfo.reception_number.trim()
                    ? "border-red-500"
                    : ""
                  }`}
              />
              <Input
                ...
                className={`${!receptionInfo.reception_date ? "border-red-500" : ""
                  }`}
              />
            </div>
            ...
            {orderGroups.map((grp, i) => (
              <div key={i} className="mb4 border border-gray-200 rounded-lg p-3">
                ...
                <Input
                  ...
                  className={`mb-2 ${!grp.order_number.trim() ? "border-red-500" : ""
                    }`}
                />
                    ...
                    >
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-4 gap-2">
                        <Input
                          ...
                          className={`${!p.piece_name.trim() ? "border-red-500" : ""
                            }`}
                        />
                        <Input
                          ...
                          className={`${!p.part_id.trim() ? "border-red-500" : ""
                            }`}
                        />
                        <Input
                          ...
                          className={`${!String(p.number_of_pieces).trim()
                              ? "border-red-500"
                              : ""
                            }`}
                        />
                        <Select
                          ...
                          className={`${!p.order_channel.trim() ? "border-red-500" : ""
                            }`}
                        />
                        {p.order_channel === "انبار مرکزی" && (
                          <>
                            <Input
                              ...
                              className={`md:col-span-2 ${!p.market_name.trim()
                                  ? "border-red-500"
                                  : ""
                                }`}
                            />
                            <Input
                              ...
                              className={`md:col-span-2 ${!p.market_phone.trim()
                                  ? "border-red-500"
                                  : ""
                                }`}
                            />
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-2 mt-2">
                        <Input
                          ...
                          className={`${!p.prediction_delivery_date?.trim() ? "border-red-500" : ""
                            }`}
                        />
                        <Select
              ...
              registeredPieces.map((piece, idx) => (
                ...
                >
                  ...
                  <div className="flex space-x-4">
                    ...
                    <p
                      className={`text-sm ${piece.order_channel === "VOR"
                          ? "text-gray-400"
                          : "text-gray-600"
                        }`}
                    >
