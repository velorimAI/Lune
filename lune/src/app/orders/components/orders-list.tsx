...
export const OrdersList: React.FC<OrdersListProps> = ({ data }) => {
            ...
            <div className="flex items-center gap-1.5 text-gray-800">
              ...
              <span>
                {order?.receptions
                  ...
                  ?.sort((a, b) => a.reception_date.localeCompare(b.reception_date))[0]
                  ?.reception_date?.split(" ")[0] || "—"}
              </span>
            </div>

            <div className="flex items-center gap-1.5 text-gray-800">
              <CalendarCheck className="w-5 h-5" />
              <span>{order?.latest_unreceived_estimated_arrival_date || "—"}</span>
            </div>
